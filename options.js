...
const highlightMatchesDisplay = document.getElementById(
  "highlight-matches-display"
);
const darkModeCheckbox = document.getElementById("dark-mode");
const darkModeDisplay = document.getElementById("dark-mode-display");

chrome.storage.sync.get(
  ["debug", "highlightMatches", "darkMode"],
  function ({ debug, highlightMatches, darkMode }) {
